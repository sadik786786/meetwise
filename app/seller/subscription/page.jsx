          ...
          <div className="w-full max-w-2xl mx-auto">
            ...
            <div className="text-center mb-6 sm:mb-8 lg:mb-10">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-xl mx-auto leading-relaxed px-2">
                Premium seller subscriptions are launching soon to boost your business growth.
              </p>
            </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white/80 rounded-lg sm:rounded-xl backdrop-blur-sm hover:bg-white transition-colors">
                      ...
                      <div className="text-left">
                        <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Premium Visibility</h3>
                        <p className="text-xs sm:text-sm text-gray-600">Top placement in buyer searches</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white/80 rounded-lg sm:rounded-xl backdrop-blur-sm hover:bg-white transition-colors">
                      ...
                      <div className="text-left">
                        <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Advanced Analytics</h3>
                        <p className="text-xs sm:text-sm text-gray-600">Detailed business insights</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white/80 rounded-lg sm:rounded-xl backdrop-blur-sm hover:bg-white transition-colors">
                      ...
                      <div className="text-left">
                        <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Unlimited Chats</h3>
                        <p className="text-xs sm:text-sm text-gray-600">Connect with all buyers</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-2 sm:space-x-3 p-3 sm:p-4 bg-white/80 rounded-lg sm:rounded-xl backdrop-blur-sm hover:bg-white transition-colors">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs sm:text-sm text-gray-600">24/7 dedicated assistance</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center">
                <div className="inline-flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl shadow-lg w-full max-w-md mx-auto">
                  ...
                  <div className="text-left flex-1">
                    <h3 className="font-bold text-yellow-900 text-sm sm:text-lg">Seller Subscriptions Coming Soon</h3>
                    <p className="text-xs sm:text-sm text-yellow-700">We're preparing exclusive benefits for sellers</p>
                  </div>
                </div>
            ...
            <div className="text-center mt-6 sm:mt-8 px-2">
              <p className="text-gray-500 text-xs sm:text-sm">
                Stay tuned for updates. We'll notify you when seller subscriptions are available.
              </p>
            </div>
          </div>
        </div>
